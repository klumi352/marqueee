...
import BlogImage2 from '../../Assets/images/images/nft_sm_1.jpg'
const ServiceData = {
    rpost:[
        {
            id: '01',
    ...
    Blist: [
        {
            ...
            bdescription: 'Hello and welcome to Marquee.Market, or MM, the first-ever NFT ad marketplace platform! Think ad space ownership, but digital. Imagine driving and seeing billboards, but instead of businesses renting those billboards, they own and advertise on them. Non-fungible tokens (NFTs) are ...',
            pdate: '14',
            Month: 'June',
            year: '2022',
            link: 'Marquee_Market_has_Launched'
